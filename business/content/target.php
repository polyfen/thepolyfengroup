<section id="target">
    <h2 class="heading-1">8. Target</h2>
    ...
    <tr>
        <th>Solution</th>
        <td><p>[End-to-End Project] Finding a reliable team of experts who can translate his vision for the business into a compelling brand identity and a website with user experience that delivers a good, professional, trustworthy impression to prospects and interests them in becoming paying clients.</p></td>
    </tr>
    <tr>
...
<table class="buyer-persona" id="executive-consulting">
    ...
    <tr>
        <th>Solution</th>
        <td><p>[Hourly Services for Executive Consulting]</p></td>
    </tr>
    <tr>
        <th>How will they measure success?</th>
...
<table class="buyer-persona" id="staff-augmentation">
    ...
    <tr>
        <th>Solution</th>
        <td><p>[Hourly Services for Staff Augmentation]</p></td>
    </tr>
    <tr>
        <th>How will they measure success?</th>
