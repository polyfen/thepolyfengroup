                ...
                <ul class="table-of-contents">
                    ...
                    <li><a href="#development-workflow" class="caption">11. Development workflow</a>
                        <ul>
                            ...
                            <li><a href="#plkt-release-checklist" class="caption">11.4. Polykit Releases</a>
                                <ul>
                                    <li><a href="#release-checklist" class="caption">Before Release</li>
                                    <li><a href="#version-checklist" class="caption">After Release</a></li>
                            </li>
                        </ul>
                    </li>
